...
const Footer = () => {
  ...
  const whatsappNumber = '+966595910906';
  ...
  return (
    <>
            ...
            >
              ...
              <div className="flex flex-col gap-3">
                ...
                <div className="flex items-center justify-end ">
                  <PhoneNumber number="+966 59 591 0906" />
                  <div className="bg-primary/20 p-2 rounded-full group-hover:bg-primary/40 transition-colors duration-300">
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
                      className="h-5 w-5 text-primary"
      ...
      <a
        ...
        target="_blank"
        rel="noopener noreferrer"
        className="fixed bottom-6 left-6 text-white rounded-full p-3 shadow-lg transition-all duration-300 hover:scale-110 bg-green-600 z-50 flex items-center justify-center animate-pulse hover:animate-none"
      ...
      {copied && <div className="text-green-400 text-sm mt-2">تم نسخ: {copied}</div>}
    </>
  );
};
